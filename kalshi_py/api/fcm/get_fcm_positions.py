...
from ...models.get_fcm_positions_settlement_status import GetFCMPositionsSettlementStatus
...
def _get_kwargs(
    *,
    ...
    settlement_status: Union[Unset, GetFCMPositionsSettlementStatus] = UNSET,
...
) -> Optional[Union[Any, GetPositionsResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, GetPositionsResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        settlement_status (Union[Unset, GetFCMPositionsSettlementStatus]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, GetPositionsResponse]
    """
