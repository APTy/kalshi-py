...
from ...models.github_com_kalshi_exchange_infra_svc_api_2_model_get_multivariate_event_collection_response import (
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GithubComKalshiExchangeInfraSvcApi2ModelGetMultivariateEventCollectionResponse.from_dict(response.json())
