...
T = TypeVar("T", bound="SvcApi2ModelMilestone")


@_attrs_define
class SvcApi2ModelMilestone:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_milestone.additional_properties = d
        return svc_api_2_model_milestone
