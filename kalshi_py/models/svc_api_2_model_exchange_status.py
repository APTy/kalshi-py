...
T = TypeVar("T", bound="SvcApi2ModelExchangeStatus")


@_attrs_define
class SvcApi2ModelExchangeStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_exchange_status = cls(
            exchange_active=exchange_active,
            exchange_estimated_resume_time=exchange_estimated_resume_time,
            trading_active=trading_active,
        )

        svc_api_2_model_exchange_status.additional_properties = d
        return svc_api_2_model_exchange_status
