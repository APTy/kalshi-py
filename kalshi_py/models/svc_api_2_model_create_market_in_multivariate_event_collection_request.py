...
T = TypeVar("T", bound="SvcApi2ModelCreateMarketInMultivariateEventCollectionRequest")


@_attrs_define
class SvcApi2ModelCreateMarketInMultivariateEventCollectionRequest:
    """
    Attributes:
        selected_markets (Union[Unset, list['SvcApi2ModelTickerPair']]): List of selected markets that act as parameters
            to determine which market is created.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_create_market_in_multivariate_event_collection_request = cls(
            selected_markets=selected_markets,
        )

        svc_api_2_model_create_market_in_multivariate_event_collection_request.additional_properties = d
        return svc_api_2_model_create_market_in_multivariate_event_collection_request
