...
T = TypeVar("T", bound="SvcApi2ModelCreateOrderResponse")


@_attrs_define
class SvcApi2ModelCreateOrderResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_create_order_response = cls(
            order=order,
        )

        svc_api_2_model_create_order_response.additional_properties = d
        return svc_api_2_model_create_order_response
