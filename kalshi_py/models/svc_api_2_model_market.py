...
T = TypeVar("T", bound="SvcApi2ModelMarket")


@_attrs_define
class SvcApi2ModelMarket:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_market.additional_properties = d
        return svc_api_2_model_market
