...
T = TypeVar("T", bound="SvcApi2ModelBatchCancelOrdersResponseOrdersItem")


@_attrs_define
class SvcApi2ModelBatchCancelOrdersResponseOrdersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_batch_cancel_orders_response_orders_item = cls(
            error=error,
            order=order,
            order_id=order_id,
        ...
        svc_api_2_model_batch_cancel_orders_response_orders_item.additional_properties = d
        return svc_api_2_model_batch_cancel_orders_response_orders_item
