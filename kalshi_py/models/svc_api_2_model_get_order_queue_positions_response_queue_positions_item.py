...
T = TypeVar("T", bound="SvcApi2ModelGetOrderQueuePositionsResponseQueuePositionsItem")


@_attrs_define
class SvcApi2ModelGetOrderQueuePositionsResponseQueuePositionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_order_queue_positions_response_queue_positions_item = cls(
            market_ticker=market_ticker,
            order_id=order_id,
            queue_position=queue_position,
        )

        svc_api_2_model_get_order_queue_positions_response_queue_positions_item.additional_properties = d
        return svc_api_2_model_get_order_queue_positions_response_queue_positions_item
