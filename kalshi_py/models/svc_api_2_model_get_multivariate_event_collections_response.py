...
if TYPE_CHECKING:
    from ..models.svc_api_2_model_multivariate_event_collection import SvcApi2ModelMultivariateEventCollection


T = TypeVar("T", bound="SvcApi2ModelGetMultivariateEventCollectionsResponse")


@_attrs_define
class SvcApi2ModelGetMultivariateEventCollectionsResponse:
    """
    Attributes:
        ...
        multivariate_contracts (Union[Unset, list['SvcApi2ModelMultivariateEventCollection']]): List of multivariate
            event collections.
    """

    cursor: Union[Unset, str] = UNSET
    multivariate_contracts: Union[Unset, list["SvcApi2ModelMultivariateEventCollection"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for multivariate_contracts_item_data in _multivariate_contracts or []:
            multivariate_contracts_item = SvcApi2ModelMultivariateEventCollection.from_dict(
                multivariate_contracts_item_data
            )

            multivariate_contracts.append(multivariate_contracts_item)

        svc_api_2_model_get_multivariate_event_collections_response = cls(
            cursor=cursor,
            multivariate_contracts=multivariate_contracts,
        )

        svc_api_2_model_get_multivariate_event_collections_response.additional_properties = d
        return svc_api_2_model_get_multivariate_event_collections_response
