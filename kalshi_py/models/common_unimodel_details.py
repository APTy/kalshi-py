...
T = TypeVar("T", bound="CommonUnimodelDetails")


@_attrs_define
class CommonUnimodelDetails:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_unimodel_details = cls(
            key=key,
        )

        common_unimodel_details.additional_properties = d
        return common_unimodel_details
