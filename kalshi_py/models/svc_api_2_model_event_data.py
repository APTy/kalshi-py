...
T = TypeVar("T", bound="SvcApi2ModelEventData")


@_attrs_define
class SvcApi2ModelEventData:
    """
    Attributes:
        ...
        markets (Union[Unset, list['SvcApi2ModelMarket']]): Array of markets associated with this event. Only populated
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_event_data = cls(
            category=category,
        ...
        svc_api_2_model_event_data.additional_properties = d
        return svc_api_2_model_event_data
