...
T = TypeVar("T", bound="SvcApi2ModelOrderConfirmation")


@_attrs_define
class SvcApi2ModelOrderConfirmation:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_order_confirmation = cls(
            action=action,
        ...
        svc_api_2_model_order_confirmation.additional_properties = d
        return svc_api_2_model_order_confirmation
