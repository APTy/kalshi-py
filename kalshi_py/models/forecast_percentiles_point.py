...
if TYPE_CHECKING:
    from ..models.forecast_percentiles_point_percentile_points_item import ForecastPercentilesPointPercentilePointsItem
...
class ForecastPercentilesPoint:
    ...
    Attributes:
        ...
        percentile_points (Union[Unset, list['ForecastPercentilesPointPercentilePointsItem']]):
        period_interval (Union[Unset, int]):
    """

    end_period_ts: Union[Unset, int] = UNSET
    event_ticker: Union[Unset, str] = UNSET
    percentile_points: Union[Unset, list["ForecastPercentilesPointPercentilePointsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.forecast_percentiles_point_percentile_points_item import (
        ...
        for percentile_points_item_data in _percentile_points or []:
            percentile_points_item = ForecastPercentilesPointPercentilePointsItem.from_dict(percentile_points_item_data)
