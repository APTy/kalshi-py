...
T = TypeVar("T", bound="SvcApi2ModelMultivariateEventCollection")


@_attrs_define
class SvcApi2ModelMultivariateEventCollection:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_multivariate_event_collection = cls(
        ...
        svc_api_2_model_multivariate_event_collection.additional_properties = d
        return svc_api_2_model_multivariate_event_collection
