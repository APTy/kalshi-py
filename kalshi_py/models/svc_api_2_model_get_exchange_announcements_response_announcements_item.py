...
T = TypeVar("T", bound="SvcApi2ModelGetExchangeAnnouncementsResponseAnnouncementsItem")


@_attrs_define
class SvcApi2ModelGetExchangeAnnouncementsResponseAnnouncementsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_exchange_announcements_response_announcements_item = cls(
        ...
        svc_api_2_model_get_exchange_announcements_response_announcements_item.additional_properties = d
        return svc_api_2_model_get_exchange_announcements_response_announcements_item
