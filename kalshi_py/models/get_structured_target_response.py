...
T = TypeVar("T", bound="GetStructuredTargetResponse")


@_attrs_define
class GetStructuredTargetResponse:
    """
    Attributes:
        structured_target (Union[Unset, StructuredTarget]):
    """

    structured_target: Union[Unset, "StructuredTarget"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_structured_target, Unset):
            ...
            structured_target = StructuredTarget.from_dict(_structured_target)

        get_structured_target_response = cls(
            structured_target=structured_target,
        )

        get_structured_target_response.additional_properties = d
        return get_structured_target_response
