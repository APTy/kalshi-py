...
from ..models.svc_api_2_model_create_order_request_action import SvcApi2ModelCreateOrderRequestAction
from ..models.svc_api_2_model_create_order_request_side import SvcApi2ModelCreateOrderRequestSide
from ..models.svc_api_2_model_create_order_request_time_in_force import SvcApi2ModelCreateOrderRequestTimeInForce
from ..models.svc_api_2_model_create_order_request_type import SvcApi2ModelCreateOrderRequestType
from ..types import UNSET, Unset

T = TypeVar("T", bound="SvcApi2ModelCreateOrderRequest")


@_attrs_define
class SvcApi2ModelCreateOrderRequest:
    """
    Attributes:
        action (Union[Unset, SvcApi2ModelCreateOrderRequestAction]): Specifies if this is a buy or sell order.
        ...
        side (Union[Unset, SvcApi2ModelCreateOrderRequestSide]): Specifies if this is a 'yes' or 'no' order.
        ticker (Union[Unset, str]): The ticker of the market the order will be placed in.
        time_in_force (Union[Unset, SvcApi2ModelCreateOrderRequestTimeInForce]): Currently only 'fill_or_kill' and
            'immediate_or_cancel' are supported. Other time in forces are controlled through expiration_ts.
        type_ (Union[Unset, SvcApi2ModelCreateOrderRequestType]): Specifies if this is a 'market' or a 'limit' order.
    ...
    action: Union[Unset, SvcApi2ModelCreateOrderRequestAction] = UNSET
    ...
    side: Union[Unset, SvcApi2ModelCreateOrderRequestSide] = UNSET
    ticker: Union[Unset, str] = UNSET
    time_in_force: Union[Unset, SvcApi2ModelCreateOrderRequestTimeInForce] = UNSET
    type_: Union[Unset, SvcApi2ModelCreateOrderRequestType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        action: Union[Unset, SvcApi2ModelCreateOrderRequestAction]
        if isinstance(_action, Unset):
            action = UNSET
        else:
            action = SvcApi2ModelCreateOrderRequestAction(_action)
        ...
        side: Union[Unset, SvcApi2ModelCreateOrderRequestSide]
        if isinstance(_side, Unset):
            side = UNSET
        else:
            side = SvcApi2ModelCreateOrderRequestSide(_side)

        ticker = d.pop("ticker", UNSET)

        _time_in_force = d.pop("time_in_force", UNSET)
        time_in_force: Union[Unset, SvcApi2ModelCreateOrderRequestTimeInForce]
        if isinstance(_time_in_force, Unset):
            time_in_force = UNSET
        else:
            time_in_force = SvcApi2ModelCreateOrderRequestTimeInForce(_time_in_force)

        _type_ = d.pop("type", UNSET)
        type_: Union[Unset, SvcApi2ModelCreateOrderRequestType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = SvcApi2ModelCreateOrderRequestType(_type_)

        yes_price = d.pop("yes_price", UNSET)

        yes_price_dollars = cast(list[int], d.pop("yes_price_dollars", UNSET))

        svc_api_2_model_create_order_request = cls(
            action=action,
        ...
        svc_api_2_model_create_order_request.additional_properties = d
        return svc_api_2_model_create_order_request
