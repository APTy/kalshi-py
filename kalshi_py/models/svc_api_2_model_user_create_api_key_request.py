...
T = TypeVar("T", bound="SvcApi2ModelUserCreateApiKeyRequest")


@_attrs_define
class SvcApi2ModelUserCreateApiKeyRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_user_create_api_key_request = cls(
            name=name,
            public_key=public_key,
        )

        svc_api_2_model_user_create_api_key_request.additional_properties = d
        return svc_api_2_model_user_create_api_key_request
