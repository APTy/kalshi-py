...
T = TypeVar("T", bound="CommonExchangeMetadataScheduleStandardHoursItemMondayItem")


@_attrs_define
class CommonExchangeMetadataScheduleStandardHoursItemMondayItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_exchange_metadata_schedule_standard_hours_item_monday_item = cls(
            close_time=close_time,
            open_time=open_time,
        )

        common_exchange_metadata_schedule_standard_hours_item_monday_item.additional_properties = d
        return common_exchange_metadata_schedule_standard_hours_item_monday_item
