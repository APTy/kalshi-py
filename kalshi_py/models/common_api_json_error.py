...
T = TypeVar("T", bound="CommonApiJSONError")


@_attrs_define
class CommonApiJSONError:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_api_json_error.additional_properties = d
        return common_api_json_error
