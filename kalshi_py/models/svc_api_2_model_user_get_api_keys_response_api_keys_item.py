...
T = TypeVar("T", bound="SvcApi2ModelUserGetApiKeysResponseApiKeysItem")


@_attrs_define
class SvcApi2ModelUserGetApiKeysResponseApiKeysItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_user_get_api_keys_response_api_keys_item = cls(
            api_key_id=api_key_id,
            created_ts=created_ts,
            name=name,
        )

        svc_api_2_model_user_get_api_keys_response_api_keys_item.additional_properties = d
        return svc_api_2_model_user_get_api_keys_response_api_keys_item
