...
T = TypeVar(
    "T",
    bound="GithubComKalshiExchangeInfraSvcApi2ModelGetMultivariateEventCollectionLookupHistoryResponseLookupPointsItem",
)


@_attrs_define
class GithubComKalshiExchangeInfraSvcApi2ModelGetMultivariateEventCollectionLookupHistoryResponseLookupPointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item = cls(
        ...
        github_com_kalshi_exchange_infra_svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item.additional_properties = d
        return github_com_kalshi_exchange_infra_svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item
