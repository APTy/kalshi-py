...
T = TypeVar("T", bound="SvcApi2ModelDecreaseOrderRequest")


@_attrs_define
class SvcApi2ModelDecreaseOrderRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_decrease_order_request = cls(
            reduce_by=reduce_by,
            reduce_to=reduce_to,
        )

        svc_api_2_model_decrease_order_request.additional_properties = d
        return svc_api_2_model_decrease_order_request
