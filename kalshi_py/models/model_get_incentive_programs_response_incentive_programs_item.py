...
T = TypeVar("T", bound="ModelGetIncentiveProgramsResponseIncentiveProgramsItem")


@_attrs_define
class ModelGetIncentiveProgramsResponseIncentiveProgramsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_get_incentive_programs_response_incentive_programs_item = cls(
        ...
        model_get_incentive_programs_response_incentive_programs_item.additional_properties = d
        return model_get_incentive_programs_response_incentive_programs_item
