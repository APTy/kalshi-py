...
T = TypeVar("T", bound="SvcApi2ModelCreateOrderGroupRequest")


@_attrs_define
class SvcApi2ModelCreateOrderGroupRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_create_order_group_request = cls(
            contracts_limit=contracts_limit,
        )

        svc_api_2_model_create_order_group_request.additional_properties = d
        return svc_api_2_model_create_order_group_request
