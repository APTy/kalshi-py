...
T = TypeVar("T", bound="SvcApi2ModelGetOrderGroupResponse")


@_attrs_define
class SvcApi2ModelGetOrderGroupResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_order_group_response = cls(
            is_auto_cancel_enabled=is_auto_cancel_enabled,
            orders=orders,
        )

        svc_api_2_model_get_order_group_response.additional_properties = d
        return svc_api_2_model_get_order_group_response
