...
T = TypeVar("T", bound="SvcApi2ModelUserGenerateApiKeyResponse")


@_attrs_define
class SvcApi2ModelUserGenerateApiKeyResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_user_generate_api_key_response = cls(
            api_key_id=api_key_id,
            private_key=private_key,
        )

        svc_api_2_model_user_generate_api_key_response.additional_properties = d
        return svc_api_2_model_user_generate_api_key_response
