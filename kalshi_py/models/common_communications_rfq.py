...
T = TypeVar("T", bound="CommonCommunicationsRFQ")


@_attrs_define
class CommonCommunicationsRFQ:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_communications_rfq.additional_properties = d
        return common_communications_rfq
