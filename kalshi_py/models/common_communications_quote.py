...
T = TypeVar("T", bound="CommonCommunicationsQuote")


@_attrs_define
class CommonCommunicationsQuote:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_communications_quote = cls(
        ...
        common_communications_quote.additional_properties = d
        return common_communications_quote
