...
T = TypeVar("T", bound="SvcApi2ModelOrderGroupSummary")


@_attrs_define
class SvcApi2ModelOrderGroupSummary:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_order_group_summary = cls(
            id=id,
            is_auto_cancel_enabled=is_auto_cancel_enabled,
        )

        svc_api_2_model_order_group_summary.additional_properties = d
        return svc_api_2_model_order_group_summary
