...
T = TypeVar("T", bound="GetOrderGroupResponse")


@_attrs_define
class GetOrderGroupResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_order_group_response = cls(
            is_auto_cancel_enabled=is_auto_cancel_enabled,
            orders=orders,
        )

        get_order_group_response.additional_properties = d
        return get_order_group_response
