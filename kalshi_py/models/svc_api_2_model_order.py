...
T = TypeVar("T", bound="SvcApi2ModelOrder")


@_attrs_define
class SvcApi2ModelOrder:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_order.additional_properties = d
        return svc_api_2_model_order
