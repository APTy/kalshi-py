...
class MveSelectedLeg:
    """
    Attributes:
        event_ticker (Union[Unset, str]): Unique identifier for the selected event
        market_ticker (Union[Unset, str]): Unique identifier for the selected market
        side (Union[Unset, str]): The side of the selected market
    """
