...
if TYPE_CHECKING:
    from ..models.svc_api_2_model_get_positions_response_event_positions_item import (
        SvcApi2ModelGetPositionsResponseEventPositionsItem,
    )
    from ..models.svc_api_2_model_get_positions_response_market_positions_item import (
        SvcApi2ModelGetPositionsResponseMarketPositionsItem,
    )


T = TypeVar("T", bound="SvcApi2ModelGetPositionsResponse")


@_attrs_define
class SvcApi2ModelGetPositionsResponse:
    """
    Attributes:
        ...
        event_positions (Union[Unset, list['SvcApi2ModelGetPositionsResponseEventPositionsItem']]): List of event
            positions.
        market_positions (Union[Unset, list['SvcApi2ModelGetPositionsResponseMarketPositionsItem']]): List of market
            positions.
    """

    cursor: Union[Unset, str] = UNSET
    event_positions: Union[Unset, list["SvcApi2ModelGetPositionsResponseEventPositionsItem"]] = UNSET
    market_positions: Union[Unset, list["SvcApi2ModelGetPositionsResponseMarketPositionsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for event_positions_item_data in _event_positions or []:
            event_positions_item = SvcApi2ModelGetPositionsResponseEventPositionsItem.from_dict(
        ...
        for market_positions_item_data in _market_positions or []:
            market_positions_item = SvcApi2ModelGetPositionsResponseMarketPositionsItem.from_dict(
                market_positions_item_data
            )

            market_positions.append(market_positions_item)

        svc_api_2_model_get_positions_response = cls(
            cursor=cursor,
            event_positions=event_positions,
            market_positions=market_positions,
        )

        svc_api_2_model_get_positions_response.additional_properties = d
        return svc_api_2_model_get_positions_response
