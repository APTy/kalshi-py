...
T = TypeVar("T", bound="CommonUnimodelProductMetadata")


@_attrs_define
class CommonUnimodelProductMetadata:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_unimodel_product_metadata = cls(
            key=key,
        )

        common_unimodel_product_metadata.additional_properties = d
        return common_unimodel_product_metadata
