...
T = TypeVar("T", bound="SvcApi2ModelPublicTrade")


@_attrs_define
class SvcApi2ModelPublicTrade:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_public_trade = cls(
            count=count,
        ...
        svc_api_2_model_public_trade.additional_properties = d
        return svc_api_2_model_public_trade
