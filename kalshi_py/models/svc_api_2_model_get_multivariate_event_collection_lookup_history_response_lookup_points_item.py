...
T = TypeVar("T", bound="SvcApi2ModelGetMultivariateEventCollectionLookupHistoryResponseLookupPointsItem")


@_attrs_define
class SvcApi2ModelGetMultivariateEventCollectionLookupHistoryResponseLookupPointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item = cls(
        ...
        svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item.additional_properties = d
        return svc_api_2_model_get_multivariate_event_collection_lookup_history_response_lookup_points_item
