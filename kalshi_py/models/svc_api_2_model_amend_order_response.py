...
T = TypeVar("T", bound="SvcApi2ModelAmendOrderResponse")


@_attrs_define
class SvcApi2ModelAmendOrderResponse:
    """
    Attributes:
        old_order (Union[Unset, SvcApi2ModelOrder]):
        order (Union[Unset, SvcApi2ModelOrder]):
    """

    old_order: Union[Unset, "SvcApi2ModelOrder"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_old_order, Unset):
            ...
            old_order = SvcApi2ModelOrder.from_dict(_old_order)
        ...
        svc_api_2_model_amend_order_response = cls(
            old_order=old_order,
            order=order,
        )

        svc_api_2_model_amend_order_response.additional_properties = d
        return svc_api_2_model_amend_order_response
