...
T = TypeVar("T", bound="SvcApi2ModelGetRFQsResponseRfqsItem")


@_attrs_define
class SvcApi2ModelGetRFQsResponseRfqsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_rf_qs_response_rfqs_item = cls(
        ...
        svc_api_2_model_get_rf_qs_response_rfqs_item.additional_properties = d
        return svc_api_2_model_get_rf_qs_response_rfqs_item
