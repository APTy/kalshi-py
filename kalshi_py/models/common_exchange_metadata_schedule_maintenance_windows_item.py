...
T = TypeVar("T", bound="CommonExchangeMetadataScheduleMaintenanceWindowsItem")


@_attrs_define
class CommonExchangeMetadataScheduleMaintenanceWindowsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_exchange_metadata_schedule_maintenance_windows_item = cls(
            end_datetime=end_datetime,
            start_datetime=start_datetime,
        )

        common_exchange_metadata_schedule_maintenance_windows_item.additional_properties = d
        return common_exchange_metadata_schedule_maintenance_windows_item
