...
T = TypeVar("T", bound="SvcApi2ModelPriceDistribution")


@_attrs_define
class SvcApi2ModelPriceDistribution:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_price_distribution = cls(
            close=close,
        ...
        svc_api_2_model_price_distribution.additional_properties = d
        return svc_api_2_model_price_distribution
