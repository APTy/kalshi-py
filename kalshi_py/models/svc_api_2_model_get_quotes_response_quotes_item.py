...
T = TypeVar("T", bound="SvcApi2ModelGetQuotesResponseQuotesItem")


@_attrs_define
class SvcApi2ModelGetQuotesResponseQuotesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_quotes_response_quotes_item = cls(
        ...
        svc_api_2_model_get_quotes_response_quotes_item.additional_properties = d
        return svc_api_2_model_get_quotes_response_quotes_item
