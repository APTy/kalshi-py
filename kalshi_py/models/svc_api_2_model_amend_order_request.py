...
from ..models.svc_api_2_model_amend_order_request_action import SvcApi2ModelAmendOrderRequestAction
from ..models.svc_api_2_model_amend_order_request_side import SvcApi2ModelAmendOrderRequestSide
from ..types import UNSET, Unset

T = TypeVar("T", bound="SvcApi2ModelAmendOrderRequest")


@_attrs_define
class SvcApi2ModelAmendOrderRequest:
    """
    Attributes:
        action (Union[Unset, SvcApi2ModelAmendOrderRequestAction]): Specifies if this is a buy or sell order. Cannot be
            amended and is validated against original order.
        ...
        side (Union[Unset, SvcApi2ModelAmendOrderRequestSide]): Side of the order (yes or no). Cannot be amended and is
    ...
    action: Union[Unset, SvcApi2ModelAmendOrderRequestAction] = UNSET
    client_order_id: Union[Unset, str] = UNSET
    count: Union[Unset, int] = UNSET
    no_price: Union[Unset, int] = UNSET
    no_price_dollars: Union[Unset, list[int]] = UNSET
    side: Union[Unset, SvcApi2ModelAmendOrderRequestSide] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        action: Union[Unset, SvcApi2ModelAmendOrderRequestAction]
        if isinstance(_action, Unset):
            action = UNSET
        else:
            action = SvcApi2ModelAmendOrderRequestAction(_action)
        ...
        side: Union[Unset, SvcApi2ModelAmendOrderRequestSide]
        if isinstance(_side, Unset):
            side = UNSET
        else:
            side = SvcApi2ModelAmendOrderRequestSide(_side)
        ...
        svc_api_2_model_amend_order_request = cls(
            action=action,
        ...
        svc_api_2_model_amend_order_request.additional_properties = d
        return svc_api_2_model_amend_order_request
