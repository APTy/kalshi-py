...
T = TypeVar("T", bound="SvcApi2ModelGetMilestonesResponse")


@_attrs_define
class SvcApi2ModelGetMilestonesResponse:
    """
    Attributes:
        cursor (Union[Unset, str]): Cursor for pagination.
        milestones (Union[Unset, list['SvcApi2ModelMilestone']]): List of milestones.
    """

    cursor: Union[Unset, str] = UNSET
    milestones: Union[Unset, list["SvcApi2ModelMilestone"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for milestones_item_data in _milestones or []:
            milestones_item = SvcApi2ModelMilestone.from_dict(milestones_item_data)

            milestones.append(milestones_item)

        svc_api_2_model_get_milestones_response = cls(
            cursor=cursor,
            milestones=milestones,
        )

        svc_api_2_model_get_milestones_response.additional_properties = d
        return svc_api_2_model_get_milestones_response
