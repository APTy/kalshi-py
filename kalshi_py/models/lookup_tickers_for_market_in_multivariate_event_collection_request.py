...
T = TypeVar("T", bound="LookupTickersForMarketInMultivariateEventCollectionRequest")
...
class LookupTickersForMarketInMultivariateEventCollectionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        lookup_tickers_for_market_in_multivariate_event_collection_request = cls(
            selected_markets=selected_markets,
        )

        lookup_tickers_for_market_in_multivariate_event_collection_request.additional_properties = d
        return lookup_tickers_for_market_in_multivariate_event_collection_request
