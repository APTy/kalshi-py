...
T = TypeVar("T", bound="SvcApi2ModelGetPositionsResponseMarketPositionsItem")


@_attrs_define
class SvcApi2ModelGetPositionsResponseMarketPositionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_positions_response_market_positions_item = cls(
            fees_paid=fees_paid,
        ...
        svc_api_2_model_get_positions_response_market_positions_item.additional_properties = d
        return svc_api_2_model_get_positions_response_market_positions_item
