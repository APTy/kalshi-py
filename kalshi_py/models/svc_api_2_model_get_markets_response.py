...
T = TypeVar("T", bound="SvcApi2ModelGetMarketsResponse")


@_attrs_define
class SvcApi2ModelGetMarketsResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_markets_response = cls(
            cursor=cursor,
            markets=markets,
        )

        svc_api_2_model_get_markets_response.additional_properties = d
        return svc_api_2_model_get_markets_response
