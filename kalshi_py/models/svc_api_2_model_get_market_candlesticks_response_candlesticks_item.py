...
T = TypeVar("T", bound="SvcApi2ModelGetMarketCandlesticksResponseCandlesticksItem")


@_attrs_define
class SvcApi2ModelGetMarketCandlesticksResponseCandlesticksItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_market_candlesticks_response_candlesticks_item = cls(
        ...
        svc_api_2_model_get_market_candlesticks_response_candlesticks_item.additional_properties = d
        return svc_api_2_model_get_market_candlesticks_response_candlesticks_item
