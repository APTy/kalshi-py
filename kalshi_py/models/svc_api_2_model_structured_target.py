...
if TYPE_CHECKING:
    from ..models.common_unimodel_details import CommonUnimodelDetails


T = TypeVar("T", bound="SvcApi2ModelStructuredTarget")


@_attrs_define
class SvcApi2ModelStructuredTarget:
    """
    Attributes:
        details (Union[Unset, CommonUnimodelDetails]):
    ...
    details: Union[Unset, "CommonUnimodelDetails"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_details, Unset):
            ...
            details = CommonUnimodelDetails.from_dict(_details)
        ...
        svc_api_2_model_structured_target = cls(
            details=details,
            id=id,
        ...
        svc_api_2_model_structured_target.additional_properties = d
        return svc_api_2_model_structured_target
