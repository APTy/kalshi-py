...
T = TypeVar("T", bound="SvcApi2ModelFill")


@_attrs_define
class SvcApi2ModelFill:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_fill.additional_properties = d
        return svc_api_2_model_fill
