...
from ..models.svc_api_2_model_get_settlements_response_settlements_item_market_result import (
    SvcApi2ModelGetSettlementsResponseSettlementsItemMarketResult,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SvcApi2ModelGetSettlementsResponseSettlementsItem")


@_attrs_define
class SvcApi2ModelGetSettlementsResponseSettlementsItem:
    """
    Attributes:
        market_result (Union[Unset, SvcApi2ModelGetSettlementsResponseSettlementsItemMarketResult]): The outcome of the
            market settlement ('yes' or 'no').
    ...
    market_result: Union[Unset, SvcApi2ModelGetSettlementsResponseSettlementsItemMarketResult] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        market_result: Union[Unset, SvcApi2ModelGetSettlementsResponseSettlementsItemMarketResult]
        if isinstance(_market_result, Unset):
            market_result = UNSET
        else:
            market_result = SvcApi2ModelGetSettlementsResponseSettlementsItemMarketResult(_market_result)
        ...
        svc_api_2_model_get_settlements_response_settlements_item = cls(
        ...
        svc_api_2_model_get_settlements_response_settlements_item.additional_properties = d
        return svc_api_2_model_get_settlements_response_settlements_item
