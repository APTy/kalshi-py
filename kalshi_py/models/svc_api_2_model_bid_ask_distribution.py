...
T = TypeVar("T", bound="SvcApi2ModelBidAskDistribution")


@_attrs_define
class SvcApi2ModelBidAskDistribution:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_bid_ask_distribution = cls(
            close=close,
        ...
        svc_api_2_model_bid_ask_distribution.additional_properties = d
        return svc_api_2_model_bid_ask_distribution
