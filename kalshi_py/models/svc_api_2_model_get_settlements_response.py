...
if TYPE_CHECKING:
    from ..models.svc_api_2_model_get_settlements_response_settlements_item import (
        SvcApi2ModelGetSettlementsResponseSettlementsItem,
    )


T = TypeVar("T", bound="SvcApi2ModelGetSettlementsResponse")


@_attrs_define
class SvcApi2ModelGetSettlementsResponse:
    """
    Attributes:
        ...
        settlements (Union[Unset, list['SvcApi2ModelGetSettlementsResponseSettlementsItem']]): Settlement summaries for
            all markets the user participated in.
    """

    cursor: Union[Unset, str] = UNSET
    settlements: Union[Unset, list["SvcApi2ModelGetSettlementsResponseSettlementsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for settlements_item_data in _settlements or []:
            settlements_item = SvcApi2ModelGetSettlementsResponseSettlementsItem.from_dict(settlements_item_data)

            settlements.append(settlements_item)

        svc_api_2_model_get_settlements_response = cls(
            cursor=cursor,
            settlements=settlements,
        )

        svc_api_2_model_get_settlements_response.additional_properties = d
        return svc_api_2_model_get_settlements_response
