...
T = TypeVar("T", bound="CommonExchangeMetadataDailySchedule")


@_attrs_define
class CommonExchangeMetadataDailySchedule:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        common_exchange_metadata_daily_schedule = cls(
            close_time=close_time,
            open_time=open_time,
        )

        common_exchange_metadata_daily_schedule.additional_properties = d
        return common_exchange_metadata_daily_schedule
