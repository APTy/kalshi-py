...
T = TypeVar("T", bound="SvcApi2ModelCreateRFQRequest")


@_attrs_define
class SvcApi2ModelCreateRFQRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_create_rfq_request = cls(
            contracts=contracts,
            market_ticker=market_ticker,
            rest_remainder=rest_remainder,
        )

        svc_api_2_model_create_rfq_request.additional_properties = d
        return svc_api_2_model_create_rfq_request
