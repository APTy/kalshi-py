...
class EventPosition:
    ...
    Attributes:
        ...
        total_cost (Union[Unset, int]): Total spent on this event in cents
        total_cost_dollars (Union[Unset, str]): Total spent on this event in dollars
        event_exposure (Union[Unset, int]): Cost of the aggregate event position in cents
        event_exposure_dollars (Union[Unset, str]): Cost of the aggregate event position in dollars
