...
T = TypeVar("T", bound="ModelMultivariateEventCollectionAssociatedEventsItem")


@_attrs_define
class ModelMultivariateEventCollectionAssociatedEventsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        model_multivariate_event_collection_associated_events_item = cls(
        ...
        model_multivariate_event_collection_associated_events_item.additional_properties = d
        return model_multivariate_event_collection_associated_events_item
