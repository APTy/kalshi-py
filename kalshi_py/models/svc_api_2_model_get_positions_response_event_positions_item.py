...
T = TypeVar("T", bound="SvcApi2ModelGetPositionsResponseEventPositionsItem")


@_attrs_define
class SvcApi2ModelGetPositionsResponseEventPositionsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_get_positions_response_event_positions_item = cls(
        ...
        svc_api_2_model_get_positions_response_event_positions_item.additional_properties = d
        return svc_api_2_model_get_positions_response_event_positions_item
