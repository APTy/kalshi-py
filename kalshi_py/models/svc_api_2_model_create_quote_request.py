...
T = TypeVar("T", bound="SvcApi2ModelCreateQuoteRequest")


@_attrs_define
class SvcApi2ModelCreateQuoteRequest:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_create_quote_request = cls(
            no_bid=no_bid,
        ...
        svc_api_2_model_create_quote_request.additional_properties = d
        return svc_api_2_model_create_quote_request
