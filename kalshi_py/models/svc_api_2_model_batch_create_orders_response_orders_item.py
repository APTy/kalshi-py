...
T = TypeVar("T", bound="SvcApi2ModelBatchCreateOrdersResponseOrdersItem")


@_attrs_define
class SvcApi2ModelBatchCreateOrdersResponseOrdersItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        svc_api_2_model_batch_create_orders_response_orders_item = cls(
            client_order_id=client_order_id,
            error=error,
            order=order,
        )

        svc_api_2_model_batch_create_orders_response_orders_item.additional_properties = d
        return svc_api_2_model_batch_create_orders_response_orders_item
