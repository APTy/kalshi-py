...
T = TypeVar("T", bound="ForecastPercentilesPointPercentilePointsItem")


@_attrs_define
class ForecastPercentilesPointPercentilePointsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        forecast_percentiles_point_percentile_points_item = cls(
        ...
        forecast_percentiles_point_percentile_points_item.additional_properties = d
        return forecast_percentiles_point_percentile_points_item
