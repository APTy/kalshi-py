...
if TYPE_CHECKING:
    from ..models.svc_api_2_model_order_book_no_dollars_item import SvcApi2ModelOrderBookNoDollarsItem
    from ..models.svc_api_2_model_order_book_yes_dollars_item import SvcApi2ModelOrderBookYesDollarsItem


T = TypeVar("T", bound="SvcApi2ModelOrderBook")


@_attrs_define
class SvcApi2ModelOrderBook:
    """
    Attributes:
        ...
        no_dollars (Union[Unset, list['SvcApi2ModelOrderBookNoDollarsItem']]): Array of price levels for no orders. Each
        ...
        yes (Union[Unset, list[list[int]]]): Array of price levels for yes orders. Each level is [price, quantity] where
            price is in cents or centicents based on use_centi_cent parameter.
        yes_dollars (Union[Unset, list['SvcApi2ModelOrderBookYesDollarsItem']]): Array of price levels for yes orders.
            Each level is {price, quantity} where price is in dollars.
    """

    no: Union[Unset, list[list[int]]] = UNSET
    no_dollars: Union[Unset, list["SvcApi2ModelOrderBookNoDollarsItem"]] = UNSET
    yes: Union[Unset, list[list[int]]] = UNSET
    yes_dollars: Union[Unset, list["SvcApi2ModelOrderBookYesDollarsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for no_dollars_item_data in _no_dollars or []:
            no_dollars_item = SvcApi2ModelOrderBookNoDollarsItem.from_dict(no_dollars_item_data)
        ...
        for yes_dollars_item_data in _yes_dollars or []:
            yes_dollars_item = SvcApi2ModelOrderBookYesDollarsItem.from_dict(yes_dollars_item_data)

            yes_dollars.append(yes_dollars_item)

        svc_api_2_model_order_book = cls(
            no=no,
        ...
        svc_api_2_model_order_book.additional_properties = d
        return svc_api_2_model_order_book
